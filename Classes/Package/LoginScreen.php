...
class LoginScreen {
	...
	public function settingsLogin() {
		if ($this->wp_customize) {
			...
			$this->wp_customize->add_setting('login_background_colour', [
			...
			// Login button colour
			$this->wp_customize->add_setting('login_button_colour', [
				'capability' => 'edit_theme_options',
				'default' => '#0085ba',
			]);
			$this->wp_customize->add_control(
			...
			$this->wp_customize->add_setting('login_link_colour', [
				'capability' => 'edit_theme_options',
				'default' => '#555d66',
			]);
			$this->wp_customize->add_control(
			...
			// Login logo size
			$this->wp_customize->add_setting('login_logo_size', [
				'capability' => 'edit_theme_options',
				'sanitize_callback' => [$this, 'sanitizeAbsint'],
				'default' => 320,
			]);
			$this->wp_customize->add_control('login_logo_size', [
				'type' => 'number',
				'section' => 'theme_mods_loginpage',
