...
export const watch = () => {
	...
	gulp.watch(config.assetsDir + 'settings.json', settings, gulp.series(gutenberg, preact, scripts, styles));
...
export const taskDefault = gulp.series(gulp.parallel(styles, scripts, preact, reload, svg), watch);
